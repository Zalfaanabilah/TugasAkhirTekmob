...
class PilihTanggal1 extends StatelessWidget {
  @override
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    margin: EdgeInsets.fromLTRB(1.2*fem, 0*fem, 1.2*fem, 0.8*fem),
                                    child: Align(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Container(
                                              margin: EdgeInsets.fromLTRB(0*fem, 0.3*fem, 1.5*fem, 0.5*fem),
                                              child: Container(
                                            ...
                                            Container(
                                              margin: EdgeInsets.fromLTRB(0*fem, 0.5*fem, 1.2*fem, 0.5*fem),
                                              child: Text(
                                                '9',
                                                style: GoogleFonts.getFont(
                                                  'Inter',
                                  ...
                                  Container(
                                    margin: EdgeInsets.fromLTRB(0.1*fem, 0*fem, 1*fem, 1*fem),
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
