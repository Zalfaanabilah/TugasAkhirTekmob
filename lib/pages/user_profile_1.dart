...
class UserProfile1 extends StatelessWidget {
  ...
  double fem = MediaQuery.of(context).size.width / 375;
    ...
    Container(
      ...
      child: Container(
        padding: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 3.7*fem),
        child: Stack(
            ...
            SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(2.1*fem, 0*fem, 1.9*fem, 1.6*fem),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(2.1*fem, 0*fem, 1.9*fem, 2.5*fem),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Container(
                  width: 8.4*fem,
                  height: 8.4*fem,
                  padding: EdgeInsets.fromLTRB(0*fem, 0*fem, 0.2*fem, 0*fem),
                  child: SizedBox(
                    width: 4*fem,
                    height: 4*fem,
                    child: SvgPicture.asset(
