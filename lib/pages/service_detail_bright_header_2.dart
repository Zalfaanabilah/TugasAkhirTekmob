...
class ServiceDetailBrightHeader2 extends StatelessWidget {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Container(
                padding: EdgeInsets.fromLTRB(1.4*fem, 1.4*fem, 1.4*fem, 1.4*fem),
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.start,
                  ...
                  children: [
                    ...
                    Container(
                      margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 2.8*fem, 0.8*fem),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Container(
                            margin: EdgeInsets.fromLTRB(0*fem, 0.2*fem, 0.5*fem, 0.3*fem),
                            child: Container(
                              decoration: BoxDecoration(
            ...
            Container(
              margin: EdgeInsets.fromLTRB(2*fem, 0*fem, 2*fem, 14.6*fem),
              child: Container(
                decoration: BoxDecoration(
