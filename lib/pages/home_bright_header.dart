...
class HomeBrightHeader extends StatelessWidget {
  @override
    ...
    Container(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              margin: EdgeInsets.fromLTRB(2.2*fem, 0*fem, 0.9*fem, 2.3*fem),
              child: Row(
                              ...
                              Container(
                                ...
                                child: Container(
                                  ...
                                  child: Container(
                                    width: 6.8*fem,
                                    height: 9.6*fem,
                                    padding: EdgeInsets.fromLTRB(0.8*fem, 3.1*fem, 0.8*fem, 3.2*fem),
                                    child: Container(
                                      decoration: BoxDecoration(
                                        ...
                                        child: Container(
                                          decoration: BoxDecoration(
                                            image: DecorationImage(
                                              fit: BoxFit.cover,
                                              image: AssetImage(
                                                'assets/images/asset_82_x_1.png',
                                              ),
                                            ),
                                          ),
                                          child: Container(
                                ...
                                Container(
                                  ...
                                  child: Container(
                                    ...
                                    child: Container(
                                      width: 4.1*fem,
                                      height: 4.1*fem,
                                      padding: EdgeInsets.fromLTRB(0.6*fem, 0.8*fem, 0.5*fem, 0.7*fem),
                                      child: Container(
                                        decoration: BoxDecoration(
                                          image: DecorationImage(
                                            fit: BoxFit.cover,
                                            image: AssetImage(
                                              'assets/images/cook_4_x_2.png',
                                            ),
                                          ),
                                        ),
                                        child: Container(
                ...
                child: Row(
                  ...
                  children: [
                            ...
                            Container(
                              ...
                              child: Container(
                                ...
                                child: Container(
                                  width: 4*fem,
                                  height: 4*fem,
                                  padding: EdgeInsets.fromLTRB(0.7*fem, 1*fem, 0.7*fem, 0*fem),
                                  child: Container(
                                    decoration: BoxDecoration(
                                      image: DecorationImage(
                                        fit: BoxFit.cover,
                                        image: AssetImage(
                                          'assets/images/bathroom_4_x_1.png',
                                        ),
                                      ),
                                    ),
                                    child: Container(
                    ...
                    Container(
                      ...
                      child: Container(
                        padding: EdgeInsets.fromLTRB(0.1*fem, 1.3*fem, 0*fem, 1.6*fem),
                        child: Stack(
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                Container(
                                  margin: EdgeInsets.fromLTRB(0.4*fem, 0*fem, 0.4*fem, 0.9*fem),
                                  child: Container(
                                    decoration: BoxDecoration(
                                      color: Color(0xFFEAEAFF),
                                      borderRadius: BorderRadius.only(
