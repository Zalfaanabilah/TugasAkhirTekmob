...
class PopupUrutkan1 extends StatelessWidget {
  @override
  ...
  double fem = MediaQuery.of(context).size.width / 360;
    ...
    Container(
      ...
      child: Container(
        padding: EdgeInsets.fromLTRB(2*fem, 1.1*fem, 0*fem, 2.3*fem),
        child: Column(
          mainAxisAlignment: MainAxisAlignment.start,
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Container(
              margin: EdgeInsets.fromLTRB(4.5*fem, 0*fem, 0*fem, 1.6*fem),
              child: Align(
            ...
            Align(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0.2*fem, 1.7*fem),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
